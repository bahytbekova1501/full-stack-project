  ...
  const cards = [
    {
      id: 1,
      // name: "sweatshirt",
      image: "https://i.ibb.co/3pGdDB5/Screenshot-47.png",
    },
    {
      // name: "hoodie",
      image: "https://i.yapx.ru/V9zSj.png",
      id: 3,
    },
    {
      // name: "dress",
      image: "https://i.yapx.ru/V9zSQ.png",
      id: 2,
    },
  ];
  const data = [
  ...
  return (
    <Section ref={element}>
      ...
      <div className="pricing__title">
        <p>Создайте полную модную коллекцию за считанные минуты.</p>
        <h2>Настройте свою 3D FitModel™</h2>
      </div>
            ...
            <motion.div
              ...
              <div className="pricing__plan__content">
                ...
                <div className="pricing__plan__content__actions">
                  <Button component={Link} to="/customyellow">
                    кастомизировать
                  </Button>
                  {/* <img
                    component={Link}
